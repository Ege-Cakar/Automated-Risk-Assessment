...
from src.text_files.system_prompts import ORGANIZER_PROMPT, CRITIC_PROMPT, SWIFT_COORDINATOR_PROMPT
...
import logging
from src.utils.filter import OutputFilter
...
async def main():
    with OutputFilter():
        try:
            ...
            for expert in approved_experts[:2]:
                expert_agent = Expert(
            ...
            # Create the team
            SwiftTeam = RoundRobinGroupChat(participants=swift_agents, model_client=base_client, termination_condition=TextMentionTermination(text="SWIFT TEAM DONE"))
